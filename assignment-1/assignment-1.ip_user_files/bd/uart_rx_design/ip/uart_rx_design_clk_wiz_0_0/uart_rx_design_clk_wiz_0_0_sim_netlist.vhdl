...
--               /home/cristian/Documents/ACES/RC/assignment-1/assignment-1.gen/sources_1/bd/uart_rx_design/ip/uart_rx_design_clk_wiz_0_0/uart_rx_design_clk_wiz_0_0_sim_netlist.vhdl
...
entity uart_rx_design_clk_wiz_0_0_clk_wiz is
  port (
    sys_clk : out STD_LOGIC;
    clk_in1 : in STD_LOGIC
  );
end uart_rx_design_clk_wiz_0_0_clk_wiz;

architecture STRUCTURE of uart_rx_design_clk_wiz_0_0_clk_wiz is
  signal clk_in1_uart_rx_design_clk_wiz_0_0 : STD_LOGIC;
  signal clkfbout_buf_uart_rx_design_clk_wiz_0_0 : STD_LOGIC;
  signal clkfbout_uart_rx_design_clk_wiz_0_0 : STD_LOGIC;
  ...
  signal sys_clk_uart_rx_design_clk_wiz_0_0 : STD_LOGIC;
  signal sys_clk_uart_rx_design_clk_wiz_0_0_en_clk : STD_LOGIC;
...
clkf_buf: unisim.vcomponents.BUFG
     port map (
      I => clkfbout_uart_rx_design_clk_wiz_0_0,
      O => clkfbout_buf_uart_rx_design_clk_wiz_0_0
    );
clkin1_ibufg: unisim.vcomponents.IBUF
    generic map(
      IOSTANDARD => "DEFAULT"
        ...
        port map (
      I => clk_in1,
      O => clk_in1_uart_rx_design_clk_wiz_0_0
    );
clkout1_buf: unisim.vcomponents.BUFGCTRL
    generic map(
      ...
      CE0 => seq_reg1(7),
      CE1 => '0',
      I0 => sys_clk_uart_rx_design_clk_wiz_0_0,
      I1 => '1',
      IGNORE0 => '0',
      IGNORE1 => '1',
      O => sys_clk,
...
clkout1_buf_en: unisim.vcomponents.BUFH
     port map (
      I => sys_clk_uart_rx_design_clk_wiz_0_0,
      O => sys_clk_uart_rx_design_clk_wiz_0_0_en_clk
    );
mmcm_adv_inst: unisim.vcomponents.MMCME2_ADV
    generic map(
      ...
      STARTUP_WAIT => false
        ...
        port map (
      CLKFBIN => clkfbout_buf_uart_rx_design_clk_wiz_0_0,
      CLKFBOUT => clkfbout_uart_rx_design_clk_wiz_0_0,
      CLKFBOUTB => NLW_mmcm_adv_inst_CLKFBOUTB_UNCONNECTED,
      CLKFBSTOPPED => NLW_mmcm_adv_inst_CLKFBSTOPPED_UNCONNECTED,
      CLKIN1 => clk_in1_uart_rx_design_clk_wiz_0_0,
      CLKIN2 => '0',
      CLKINSEL => '1',
      CLKINSTOPPED => NLW_mmcm_adv_inst_CLKINSTOPPED_UNCONNECTED,
      CLKOUT0 => sys_clk_uart_rx_design_clk_wiz_0_0,
...
\seq_reg1_reg[0]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
        ...
        port map (
      C => sys_clk_uart_rx_design_clk_wiz_0_0_en_clk,
      CE => '1',
      D => locked_int,
      Q => seq_reg1(0),
      R => '0'
...
entity uart_rx_design_clk_wiz_0_0 is
  ...
  attribute NotValidForBitStream of uart_rx_design_clk_wiz_0_0 : entity is true;
end uart_rx_design_clk_wiz_0_0;

architecture STRUCTURE of uart_rx_design_clk_wiz_0_0 is
begin
inst: entity work.uart_rx_design_clk_wiz_0_0_clk_wiz
     port map (
      clk_in1 => clk_in1,
      sys_clk => sys_clk
    );
