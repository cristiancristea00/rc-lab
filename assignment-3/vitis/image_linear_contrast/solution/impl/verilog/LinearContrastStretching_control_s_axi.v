...
// ==============================================================
`timescale 1ns/1ps
module LinearContrastStretching_control_s_axi
#(parameter
...
localparam
    ...
    ADDR_IMAGE_LENGTH_DATA_0       = 7'h20,
    ADDR_IMAGE_LENGTH_CTRL         = 7'h24,
    ADDR_LOW_THRESHOLD_DATA_0      = 7'h28,
    ADDR_LOW_THRESHOLD_CTRL        = 7'h2c,
    ADDR_HIGH_THRESHOLD_DATA_0     = 7'h30,
    ADDR_HIGH_THRESHOLD_CTRL       = 7'h34,
    ADDR_LOW_NEW_THRESHOLD_DATA_0  = 7'h38,
    ADDR_LOW_NEW_THRESHOLD_CTRL    = 7'h3c,
    ADDR_HIGH_NEW_THRESHOLD_DATA_0 = 7'h40,
    ADDR_HIGH_NEW_THRESHOLD_CTRL   = 7'h44,
    ADDR_MAX_VALUE_DATA_0          = 7'h48,
    ADDR_MAX_VALUE_CTRL            = 7'h4c,
    WRIDLE                         = 2'd0,
    WRDATA                         = 2'd1,
    WRRESP                         = 2'd2,
    WRRESET                        = 2'd3,
    ...
    if (ACLK_EN) begin
        if (ar_hs) begin
            ...
            case (raddr)
                ...
                ADDR_IMAGE_LENGTH_DATA_0: begin
...
assign image_length       = int_image_length;
assign low_threshold      = int_low_threshold;
assign high_threshold     = int_high_threshold;
assign low_new_threshold  = int_low_new_threshold;
assign high_new_threshold = int_high_new_threshold;
assign max_value          = int_max_value;
// int_interrupt
always @(posedge ACLK) begin
    if (ARESET)
        int_interrupt <= 1'b0;
...
// int_image_length[31:0]
always @(posedge ACLK) begin
    if (ARESET)
        int_image_length[31:0] <= 0;
    else if (ACLK_EN) begin
        if (w_hs && waddr == ADDR_IMAGE_LENGTH_DATA_0)
            int_image_length[31:0] <= (WDATA[31:0] & wmask) | (int_image_length[31:0] & ~wmask);
    end
end
