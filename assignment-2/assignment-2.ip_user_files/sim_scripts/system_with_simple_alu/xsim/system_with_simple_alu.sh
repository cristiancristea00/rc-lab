...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot system_with_simple_alu xil_defaultlib.system_with_simple_alu xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim system_with_simple_alu -key {Behavioral:sim_1:Functional:system_with_simple_alu} -tclbatch cmd.tcl -protoinst "protoinst_files/system_with_simple_alu.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb system_with_simple_alu.wdb xsim.dir libdpi.so)
