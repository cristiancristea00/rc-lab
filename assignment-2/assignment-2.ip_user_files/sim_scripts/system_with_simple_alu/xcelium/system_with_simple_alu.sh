...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"../../../../assignment-2.gen/sources_1/bd/system_with_simple_alu/ipshared/ec67/hdl" +incdir+"../../../../assignment-2.gen/sources_1/bd/system_with_simple_alu/ipshared/aed8/hdl" +incdir+"/home/cristian/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  ...
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../assignment-2.gen/sources_1/bd/system_with_simple_alu/ipshared/ec67/hdl" +incdir+"../../../../assignment-2.gen/sources_1/bd/system_with_simple_alu/ipshared/aed8/hdl" +incdir+"/home/cristian/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../assignment-2.gen/sources_1/bd/system_with_simple_alu/ipshared/ec67/hdl" +incdir+"../../../../assignment-2.gen/sources_1/bd/system_with_simple_alu/ipshared/aed8/hdl" +incdir+"/home/cristian/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.system_with_simple_alu xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.system_with_simple_alu -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/cristian/Documents/ACES/RC/assignment-2/assignment-2.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log system_with_simple_alu_sc.so .tmp_log xcelium_lib waves.shm c.obj)
