...
#
# Script generated by Vivado on Tue Apr 09 20:16:24 EEST 2024
# SW Build 3900603 on Fri Jun 16 19:30:25 MDT 2023
#
# Tool Version Limit: 2023.06 
#
# Filename     : linear_contrast_stretching.sh
...
#
# Usage        : linear_contrast_stretching.sh
#                linear_contrast_stretching.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                linear_contrast_stretching.sh [-reset_run]
#                linear_contrast_stretching.sh [-reset_log]
#                linear_contrast_stretching.sh [-help]
#
...
#                script (type 'linear_contrast_stretching.sh -help' for more information).
#
...
# script info
echo -e "linear_contrast_stretching.sh - Script generated by export_simulation (Vivado v2023.1.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./linear_contrast_stretching.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.linear_contrast_stretching xil_defaultlib.glbl -o linear_contrast_stretching_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./linear_contrast_stretching_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/cristian/Documents/ACES/RC/assignment-3/vivado/linear_contrast_stretching.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key linear_contrast_stretching_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc linear_contrast_stretching_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./linear_contrast_stretching.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: linear_contrast_stretching.sh [-help]\n\
Usage: linear_contrast_stretching.sh [-step]\n\
Usage: linear_contrast_stretching.sh [-lib_map_path]\n\
Usage: linear_contrast_stretching.sh [-reset_run]\n\
Usage: linear_contrast_stretching.sh [-reset_log]\n\
Usage: linear_contrast_stretching.sh [-keep_index]\n\
Usage: linear_contrast_stretching.sh [-noclean_files]\n\n\
