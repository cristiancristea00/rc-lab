...
entity LinearContrastStretching_control_s_axi is
generic (
...
end entity LinearContrastStretching_control_s_axi;
...
architecture behave of LinearContrastStretching_control_s_axi is
    ...
    constant ADDR_IMAGE_LENGTH_DATA_0       : INTEGER := 16#20#;
    constant ADDR_IMAGE_LENGTH_CTRL         : INTEGER := 16#24#;
    constant ADDR_LOW_THRESHOLD_DATA_0      : INTEGER := 16#28#;
    constant ADDR_LOW_THRESHOLD_CTRL        : INTEGER := 16#2c#;
    constant ADDR_HIGH_THRESHOLD_DATA_0     : INTEGER := 16#30#;
    constant ADDR_HIGH_THRESHOLD_CTRL       : INTEGER := 16#34#;
    constant ADDR_LOW_NEW_THRESHOLD_DATA_0  : INTEGER := 16#38#;
    constant ADDR_LOW_NEW_THRESHOLD_CTRL    : INTEGER := 16#3c#;
    constant ADDR_HIGH_NEW_THRESHOLD_DATA_0 : INTEGER := 16#40#;
    constant ADDR_HIGH_NEW_THRESHOLD_CTRL   : INTEGER := 16#44#;
    constant ADDR_MAX_VALUE_DATA_0          : INTEGER := 16#48#;
    constant ADDR_MAX_VALUE_CTRL            : INTEGER := 16#4c#;
...
-- ----------------------- Register logic ----------------
    ...
    image_length         <= STD_LOGIC_VECTOR(int_image_length);
    low_threshold        <= STD_LOGIC_VECTOR(int_low_threshold);
    high_threshold       <= STD_LOGIC_VECTOR(int_high_threshold);
    low_new_threshold    <= STD_LOGIC_VECTOR(int_low_new_threshold);
    high_new_threshold   <= STD_LOGIC_VECTOR(int_high_new_threshold);
    max_value            <= STD_LOGIC_VECTOR(int_max_value);
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_IMAGE_LENGTH_DATA_0) then
                    int_image_length(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_image_length(31 downto 0));
                end if;
            end if;
        end if;
    end process;
