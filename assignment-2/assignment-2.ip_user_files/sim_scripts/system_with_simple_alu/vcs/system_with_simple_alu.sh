...
#
# Script generated by Vivado on Wed Mar 27 18:43:56 EET 2024
# SW Build 3900603 on Fri Jun 16 19:30:25 MDT 2023
#
# Tool Version Limit: 2023.06 
#
# Filename     : system_with_simple_alu.sh
...
#
# Usage        : system_with_simple_alu.sh
#                system_with_simple_alu.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                system_with_simple_alu.sh [-reset_run]
#                system_with_simple_alu.sh [-reset_log]
#                system_with_simple_alu.sh [-help]
#
...
#                script (type 'system_with_simple_alu.sh -help' for more information).
#
...
# script info
echo -e "system_with_simple_alu.sh - Script generated by export_simulation (Vivado v2023.1.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./system_with_simple_alu.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"../../../../assignment-2.gen/sources_1/bd/system_with_simple_alu/ipshared/ec67/hdl" +incdir+"../../../../assignment-2.gen/sources_1/bd/system_with_simple_alu/ipshared/aed8/hdl" +incdir+"/home/cristian/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../assignment-2.gen/sources_1/bd/system_with_simple_alu/ipshared/ec67/hdl" +incdir+"../../../../assignment-2.gen/sources_1/bd/system_with_simple_alu/ipshared/aed8/hdl" +incdir+"/home/cristian/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../assignment-2.gen/sources_1/bd/system_with_simple_alu/ipshared/ec67/hdl" +incdir+"../../../../assignment-2.gen/sources_1/bd/system_with_simple_alu/ipshared/aed8/hdl" +incdir+"/home/cristian/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.system_with_simple_alu xil_defaultlib.glbl -o system_with_simple_alu_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./system_with_simple_alu_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/cristian/Documents/ACES/RC/assignment-2/assignment-2.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key system_with_simple_alu_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc system_with_simple_alu_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./system_with_simple_alu.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: system_with_simple_alu.sh [-help]\n\
Usage: system_with_simple_alu.sh [-step]\n\
Usage: system_with_simple_alu.sh [-lib_map_path]\n\
Usage: system_with_simple_alu.sh [-reset_run]\n\
Usage: system_with_simple_alu.sh [-reset_log]\n\
Usage: system_with_simple_alu.sh [-keep_index]\n\
Usage: system_with_simple_alu.sh [-noclean_files]\n\n\
